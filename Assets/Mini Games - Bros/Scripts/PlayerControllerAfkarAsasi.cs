...
public class PlayerControllerAfkarAsasi : MonoBehaviour
{
...
*/
    ...
    void OnEnable()
    {
        if (SceneManager.GetActiveScene().name == "Mini Bros Afkar Asasi")
        {
            checkpoint = GetComponent<Checkpoint>();
    ...
    private void Start()
    {
        ...
        //     // print(item);
        // }
        // pretest_aasasi.experience = pengalaman;
    ...
    private void Update()
    {
            ...
            if (skor_converted != 0)
            {
                switch (materi_id)
                {
                    case 1:
                        ...
                        time1 += time_finish;
                        pretest_aasasi.answer1[pretest_aasasi.indexAnswer1++] = answer;
                        break;
                    case 2:
                        skor2 += skor_converted;
                        time2 += time_finish;
                        pretest_aasasi.answer2[pretest_aasasi.indexAnswer2++] = answer;
                        break;
                    case 3:
                        skor3 += skor_converted;
                        time3 += time_finish;
                        pretest_aasasi.answer3[pretest_aasasi.indexAnswer3++] = answer;
                        break;
                    case 4:
                        skor4 += skor_converted;
                        time4 += time_finish;
                        pretest_aasasi.answer4[pretest_aasasi.indexAnswer4++] = answer;
                        break;
                    default:
                        break;
                }
        ...
        if (pretest_stat == true)
        {
            ...
            {
                pretest_aasasi.scores[i] = final_score[i];
                pretest_aasasi.times[i] = final_time[i];
                pretest_aasasi.experience[i] = final_exp[i];
            }
            print("skor1: " + skor1);
            print("skor2: " + skor2);
            print("skor3: " + skor3);
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.tag == "book")
        {
            ...
            SceneManager.LoadScene("QuestionSceneAfkar Asasi");
        }
        if (collision.tag == "book2")
        {
            ...
            checkpoint.change_scene = true;
            destroying(collision.gameObject);
            SceneManager.LoadScene("QuestionScene2Afkar Asasi");
        ...
        if (collision.tag == "book3")
        {
            ...
            checkpoint.change_scene = true;
            destroying(collision.gameObject);
            SceneManager.LoadScene("QuestionScene3Afkar Asasi");
        }
        if (collision.tag == "book4")
        {
            ...
            checkpoint.change_scene = true;
            destroying(collision.gameObject);
            SceneManager.LoadScene("QuestionSceneAfkarAsasi");
        }

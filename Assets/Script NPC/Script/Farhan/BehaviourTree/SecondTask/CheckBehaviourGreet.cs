...
public class CheckBehaviourGreet : Node
{
    ...
    public CheckBehaviourGreet(PlayerData playerData ,GameObject player, GameObject npc, Transform transform)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        if (hasTest == true && hasExp == true && AltBehaviour == Alt1)
        {

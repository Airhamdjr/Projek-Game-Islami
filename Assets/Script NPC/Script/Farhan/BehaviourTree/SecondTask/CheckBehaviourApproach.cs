...
public class CheckBehaviourApproach : Node
{
    ...
    public CheckBehaviourApproach(PlayerData playerData, GameObject player, GameObject npc, Transform transform)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        if (hasTest == true && hasExp == true && AltBehaviour == Alt2)
        {
            if (Vector3.Distance(_transform.position, _player.transform.position) < 3f)
            {
                ...
                Debug.Log("Nilai = " + nilai + " Soal Terjawab Salah");

...
public class CheckBehaviourFollow : Node
{
    ...
    public CheckBehaviourFollow(PlayerData playerData, GameObject player, GameObject npc, Transform transform)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        if (hasTest == true && hasExp == true && AltBehaviour == Alt3)
        {
